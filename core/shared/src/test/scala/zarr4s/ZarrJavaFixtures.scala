...
/** Direct Zarr v3 fixture written by zarr-java 0.1.3.
  *
  * Generated with `tools/verify_zarr_java_oracle.py write-fixture`. The raw metadata and chunk
  * hashes make the independent writer provenance inspectable without adding zarr-java to the Scala
  * build.
  */
