...
final class ChunkCoordinate private[zarr] (private[zarr] val values: Array[Long]):
...
object ChunkCoordinate:
  private[zarr] def unsafe(values: Array[Long]): ChunkCoordinate =
...
object StoreKey:
  ...
  private[zarr] def unsafe(value: String): StoreKey = value

  extension (key: StoreKey)
...
object ZarrPath:
  ...
  private[zarr] def unsafe(value: String): ZarrPath = value
