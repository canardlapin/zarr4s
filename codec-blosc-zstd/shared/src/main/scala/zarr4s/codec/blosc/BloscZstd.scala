...
object BloscCompressionLevel:
  ...
  extension (level: BloscCompressionLevel) inline def toInt: Int = level
...
object BloscTypeSize:
  ...
  extension (size: BloscTypeSize) inline def toInt: Int = size
...
object BloscBlockSize:
  ...
  extension (size: BloscBlockSize) inline def toInt: Int = size
